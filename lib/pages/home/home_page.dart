...
class _HomePageState extends State<HomePage> {
  ...
  List<GlassTab> _cachedTabs = const [];
    ...
    return GlassTabShell(
          ...
          title: SignalBuilder(
            builder: (context) {
              ...
              return Wrap(
                ...
                children: [
                  GlassButton.custom(
                    onTap: _watcher.startNotificationService,
                    height: 44,
                  ...
                  GlassButton.custom(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          const Icon(UniconsLine.history, size: 18),
                          const SizedBox(width: 8),
                          Text(
                            'Export History'.tr,
                            style: const TextStyle(fontSize: 16),
      ...
      body: Column(
        ...
        children: [
          ...
          Expanded(child: _HomeRecordsList(
            watcher: _watcher,
